...
export const mockUsers: User[] = [
  ...
  },
  {
    ...
    name: 'Leo',
    username: 'leomacro',
    bio: 'Thinking about capital, information, and what compounds over time.',
    avatar: 'https://api.dicebear.com/7.x/initials/svg?seed=Leo&backgroundColor=162032&textColor=60A5FA',
    relationshipStrength: 0.85,
    orbit: ['Markets', 'Macro', 'Investing'],
  },
  {
    id: 'user_nia',
    name: 'Nia',
    username: 'niaworld',
    bio: 'Culture, visual art, and the places where categories break down.',
    avatar: 'https://api.dicebear.com/7.x/initials/svg?seed=Nia&backgroundColor=1a0f2e&textColor=E879F9',
    relationshipStrength: 0.72,
    orbit: ['Art', 'Culture', 'Writing'],
  },
  {
    id: 'user_priya',
    name: 'Priya',
    username: 'priyareads',
    bio: 'Deep work, hard problems, long books. Trying to understand how things actually work.',
    avatar: 'https://api.dicebear.com/7.x/initials/svg?seed=Priya&backgroundColor=0f1f1a&textColor=34D399',
    relationshipStrength: 0.68,
    orbit: ['Science', 'Research', 'Books'],
  },
]
    ...
    picks: [
      {
        ...
        note: 'The dramatic stuff is always a symptom. The plumbing breaks first — quietly, invisibly — and by the time it\'s visible it\'s already too late to call it a surprise.',
        order: 0,
      },
      {
        id: 'pick_leo_1b',
        ...
        note: 'Still can\'t explain why this works but it does. Something about the way the samples decay. On repeat during a flight and I missed landing.',
        order: 1,
      },
      {
        id: 'pick_leo_1c',
        ...
        note: 'Not patience as tolerance for inaction, but patience as a deliberate bet. Most people treat waiting as the absence of strategy. The best investors treat it as the strategy itself.',
        order: 2,
      },
    ],
  },
    ...
    picks: [
      {
        ...
        note: 'The machine doesn\'t simulate the ocean — it finds the ocean hiding inside the data. I stood in front of it for a long time and stopped trying to understand it. That\'s when it worked.',
        order: 0,
      },
      {
        id: 'pick_nia_1b',
        ...
        note: 'About invisibility as both burden and strategy. How some people have always known how to move through space by becoming it. I kept thinking about this for days after.',
        order: 1,
      },
      {
        id: 'pick_nia_1c',
        ...
        source: 'Internet',
        note: 'Something genuinely interesting is happening in how she turned concert documentation into a distributed visual language. The fans are the medium. The artifact keeps changing.',
        order: 2,
      },
    ],
  },
    ...
    picks: [
      {
        ...
        note: 'Written before his famous work but somehow the clearest thing he ever wrote. Mental effort as a scarce resource that depletes. Makes you think about what you\'re actually spending it on.',
        order: 0,
      },
      {
        id: 'pick_priya_1b',
        ...
        note: 'Three hours I didn\'t feel. Deutsch on why most "explanations" are just descriptions wearing a lab coat. Changed how I think about any claim that says it knows why something happens.',
        order: 1,
      },
      {
        id: 'pick_priya_1c',
        ...
        source: 'Personal note',
        note: 'Novices know the map is approximate. Experts forget. The more fluent you become in a model, the more it forecloses other ways of seeing. I think about this whenever I\'m very confident about something.',
        order: 2,
      },
    ],
  },
